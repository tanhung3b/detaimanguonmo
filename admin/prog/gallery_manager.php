...
?>
  <tr class="tb_foot">
    <td style="text-align:right;"><input type="text" class="inputbox" id="cat_<?=$row["id"]?>" value="<?=$row["ten"]?>"> <a ><input type="button" onclick="edit_cat_thongtin('<?=$row["id"]?>')" class="inputbox" value="Sửa"></a></td>

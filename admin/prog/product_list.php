...
<div class="function">
	<a href="?act=product_new&txt_cat=<?=$id?>"><img src="images/add_new.gif" align="absmiddle" border="0" /></a> <a href="?act=product_new&txt_cat=<?=$id?>">Thêm sản phẩm mới</a>
</div>
<?php
...
<tr class="tb_content">
	...
	<td><?=$row["ten"]?></td>
	<td style="text-align:right;"><?=$row["gia"]?></td>
...
<div class="function">
	<a href="?act=product_new&txt_cat=<?=$id?>"><img src="images/add_new.gif" align="absmiddle" border="0" /></a> <a href="?act=product_new&txt_cat=<?=$id?>">Đăng bài viết mới</a>
</div>
...
<div class="function">
	<a href="?act=doc_new&txt_cat=<?=$id?>"><img src="images/add_new.gif" align="absmiddle" border="0" /></a> <a href="?act=doc_new&txt_cat=<?=$id?>">Thêm tài liệu mới</a>
</div>
<?php
...
<tr class="tb_content">
	...
	<td><?=$row["ten"]?></td>
	<?php //<td style="text-align:right;"><?=$row["gia"]? ></td> ?>
